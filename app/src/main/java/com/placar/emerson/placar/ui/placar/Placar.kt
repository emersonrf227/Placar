package com.placar.emerson.placar.ui.placar
...
class Placar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvTimeA.text = intent.extras.getString(KEE_EXTRA_TIMES_A)
        tvTimeB.text = intent.extras.getString(KEE_EXTRA_TIMES_B)
